...
The resulting dataset, merged_data, has the following range of years: a minimum year of `r min(pull(merged_data, year))` to a maximum year of `r max(pull(merged_data,year))`
